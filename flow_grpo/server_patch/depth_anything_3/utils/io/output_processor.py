...
class OutputProcessor:
    ...
    def __call__(self, model_output: dict[str, torch.Tensor], extrinsics_only: bool = False) -> Prediction:
        """
        ...
        Args:
            ...
            extrinsics_only: If True, only extract extrinsics and intrinsics, skip other data
        ...
        if extrinsics_only:
            # Only extract extrinsics and intrinsics for speed optimization
            depth = None
            conf = None
