...
class TableManager:
    ...
    def build_remapping_table(self, frames_guide, frames_style, patch_match_engine, batch_size, desc="building remapping table"):
        n = len(frames_guide)
    ...
    def process_window_sum(self, frames_guide, blending_table, patch_match_engine, window_size, batch_size, desc="processing window sum"):
