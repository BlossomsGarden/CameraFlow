...
#
# !!!Attention!!!
# To run VBench evlauation, pip install transformers==4.33.2
# !!!Attention!!!
#
#
# !!!Attention!!!
# To run inference_recammaster_gpu7.py, pip install transformers==4.46.2
# !!!Attention!!!
#
#
#
# CUDA_VISIBLE_DEVICES=1 \
# python evaluate.py --videos_path  /data/wlh/ReCamMaster/ReCamMaster-main/results/cam_type1  \
# --dimension    aesthetic_quality   imaging_quality    temporal_flickering   motion_smoothness  \
# subject_consistency  background_consistency   dynamic_degree \
# --mode=custom_input \
